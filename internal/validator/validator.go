...
// Struct which contains a map of validation errors.
type Validator struct {
	Errors map[string]string
}

// Creates a new Validator instance with an empty errors.
func New() *Validator {
...
// Generic function which returns true if a specific value is in a given list.
