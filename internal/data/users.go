...
// The Set() method calculates the bcrypt hash of the plaintext password and
...
// Validates the email with de apropiated Regex
...
// Return a token for the a specific user
